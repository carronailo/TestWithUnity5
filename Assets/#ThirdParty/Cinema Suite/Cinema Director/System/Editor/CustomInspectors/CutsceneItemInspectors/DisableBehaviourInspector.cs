...
public class DisableBehaviourInspector : Editor
{
	...
	private SerializedProperty componentsNameProperty;
    ...
    public void OnEnable()
    {
		...
		this.componentsNameProperty = disableBehaviour.FindProperty("BehaviourTypeName");
    ...
    public override void OnInspectorGUI()
    {
		...
		GUI.enabled = false;
		componentsNameProperty.stringValue = behaviours[componentSelection].GetType().Name;
		EditorGUILayout.PropertyField(componentsNameProperty);
		GUI.enabled = true;
