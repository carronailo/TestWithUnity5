...
public class EnableBehaviourInspector : Editor
{
    ...
    public void OnEnable()
    {
		...
		this.componentsNameProperty = enableBehaviour.FindProperty("BehaviourTypeName");
    ...
    public override void OnInspectorGUI()
    {
		...
		GUI.enabled = false;
		componentsNameProperty.stringValue = components[componentSelection].GetType().Name;
