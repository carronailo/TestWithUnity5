...
public class ActorTrackGroupInspector : Editor
{
	...
	private SerializedProperty actorTag;
	//private SerializedProperty actorGUID;
    ...
    private void OnEnable()
    {
		...
		this.actorTag = base.serializedObject.FindProperty("actorTag");
		//this.actorGUID = base.serializedObject.FindProperty("actorGUID");
	}
