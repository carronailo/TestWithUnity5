...
float _BumpAmt;
sampler2D _GrabOptimiseTexture;
float4 _GrabOptimiseTexture_TexelSize;
...
void surf (Input IN, inout SurfaceOutput o) {
	    ...
	    half2 offset = o.Normal.rg * _BumpAmt * _GrabOptimiseTexture_TexelSize.xy;
		IN.proj.xy = offset * IN.proj.z + IN.proj.xy;
		half4 col = tex2Dproj(_GrabOptimiseTexture, UNITY_PROJ_COORD(IN.proj));
