...
#if GLOW11_GLOW_MAINCOLOR || Glow11_MULTIPLY_MAINCOLOR_ALPHA
fixed4 _Color;
#endif

#if GLOW11_GLOW_TINTCOLOR || GLOW11_MULTIPLY_TINTCOLOR_ALPHA
fixed4 _TintColor;
#endif
...
PixelOutput fragGlow(v2f pixelData)
{
    ...
    o.color *= _GlowStrength;
        ...
        #endif
	#elif GLOW11_MULTIPLY_MAINCOLOR_ALPHA
		o.color *= _Color.a;
	#elif GLOW11_MULTIPLY_TINTCOLOR_ALPHA
		o.color *= _TintColor.a;
	#endif
	...
	#if GLOW11_GLOW_GLOWCOLOR
		o.color *= _GlowColor.a;
	#endif
