...
public class AtlasResourceLoader : ResourceLoaderBase
{
	protected override string IdentifyString { get { return "UI/Atlas/"; } }
	protected override string CoroutineIdentifyString { get { return "AtlasResourceLoader."; } }
	...
	{
		Debug.Log(string.Format("请求加载图集资源[{0}]", resourceName));
//#if UNITY_EDITOR
...
//                    resourceHolder = new ResourceHolder(resourceName, new AssetPackage { mainAsset = DebugResourceManager.Instance.GetResource(EResourceType.Atlas, resourceName) }, null),
...
//#endif
	...
	{
		Debug.Log(string.Format("请求释放图集资源[{0}]", requester.resourceName));
//#if UNITY_EDITOR
//        if (DebugParameters.enableDebug && DebugResourceManager.Instance != null)
//        {
//        }
