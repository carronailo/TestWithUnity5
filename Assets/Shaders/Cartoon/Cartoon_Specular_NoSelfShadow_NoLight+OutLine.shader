...
Shader "Cartoon/Specular_NoSelfShadow_NoLight+OutLine"
{
    Properties
	{
		...
		//_Outlightting("Outlightting Size", Float) = 0.005
	...
	SubShader
	{
        Tags { "Queue"="Geometry" "RenderType" = "Glow11" "RenderEffect" = "Glow11" }
		LOD 300
		...
		//UsePass "Hidden/Cartoon_Outlightting/OUTLIGHTTINGE"
