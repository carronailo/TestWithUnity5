...
Shader "ARPG Project/Particles/Alpha Blended ForShadow" {
	Properties {
		...
		SubShader {
			Pass {
				...
				fixed4 frag(v2f i) : COLOR
				{
					...
					col.rgb = 2.0f * lerp(tex,ramp.rgb * ramp * _RampM,_RampK).rgb * i.color.rgb * _TintColor.rgb * _Multiplier;
