...
Shader "ARPG Project/Particles/Scroll 2 Layers Sine AlphaBlendedEX_AlphaBlend" {
	Properties {
	...
	SubShader {
		...
		Cull Off Lighting Off ZWrite Off Fog { Color (0.4,0.4,0.4,1) }
		...
		Pass {
			...
			fixed4 frag (v2f i) : COLOR
			{
				...
				fixed4 tex3 = tex * _ColorA  + tex2 * _ColorB ;
