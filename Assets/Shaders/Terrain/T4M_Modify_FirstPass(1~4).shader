...
Shader "ARPG Project/Terrain/T4M Modify FirstPass(1~4)" 
{
	Properties 
	{
...
//			#define WorldNormalVector(data,normal) normal
			...
			struct v2f_surf
			{
				...
				half4 pack1 : TEXCOORD1;
				half2 pack2 : TEXCOORD2;
...
#else
				o.pack2.zw = v.texcoord1.xy * unity_LightmapST.xy + unity_LightmapST.zw;
			...
			fixed4 frag_surf (v2f_surf IN) : SV_Target 
			{
				...
				fixed4 lmtex = UNITY_SAMPLE_TEX2D(unity_Lightmap, IN.pack2.zw);
				fixed4 lmIndTex = UNITY_SAMPLE_TEX2D_SAMPLER(unity_LightmapInd,unity_Lightmap, IN.pack2.zw);
